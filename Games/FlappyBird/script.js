...
// ============================
let GRAVITY = 0.35;            // px/frame^2 baseline at 60fps
let FLAP_VELOCITY = -7;      // px/frame baseline at 60fps
let PIPE_VELOCITY = 2.5;       // px/frame baseline at 60fps
...
function update(dtMs) {
	...
	const dtScale = dt / (1000 / 60); // scale vs 60fps baseline
...
function scrollBackground(dt) {
	...
	groundOffset += PIPE_VELOCITY * dtScale;
	// Cloud drift
